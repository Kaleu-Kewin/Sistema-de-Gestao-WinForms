namespace Dashboard.Forms
{
    partial class FrmUsuarios
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbAcessoCompleto = new CardEstatistica();
            cbCadastrados = new CardEstatistica();
            cbComAcesso = new CardEstatistica();
            cbSemAcesso = new CardEstatistica();
        ...
        private CardEstatistica cbCadastrados;
        private CardEstatistica cbComAcesso;
        private CardEstatistica cbSemAcesso;
        private CardEstatistica cbAcessoCompleto;
