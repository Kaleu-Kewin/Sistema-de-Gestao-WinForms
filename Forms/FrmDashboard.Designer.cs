namespace Dashboard.Forms
{
    partial class FrmDashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbReceita = new CardEstatistica();
            cbVendas = new CardEstatistica();
            cbClientes = new CardEstatistica();
            cbProdutos = new CardEstatistica();
            label2 = new Label();
            label1 = new Label();
        ...
        private CardEstatistica cbReceita;
        private CardEstatistica cbVendas;
        private CardEstatistica cbClientes;
        private CardEstatistica cbProdutos;
